...
const ModalPopup = ({alertVisible, children})=>{
		...
		<Modal transparent visible={showModal} >
			<View style={{flex:1, backgroundColor:'rgb(0,0,0,,.5)', justifyContent:'center', alignItems:'center'}}>
				<Animated.View style={[styles.modalContainer, {transform:[{scale:scaleValue}]}]}>
                    ...
                    <Icon name="ios-checkmark-circle" size={150} style={{marginVertical:0}} color='#33cc33' />

                    </View>
                    <Text style={{marginVertical:20, fontSize:20, textAlign:'center', fontFamily:'Outfit_medium'}}>Account registered Successfully.</Text>
                    <Text style={{marginVertical:20, fontSize:20, textAlign:'center', fontFamily:'Outfit_medium'}}>A confirmation email has been send to your email address </Text>
